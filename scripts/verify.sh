...
echo "内容页产物："
COUNT=$(find out \( -path "*/guides/*" -o -path "*/walkthrough/*" -o -path "*/fish/*" -o -path "*/weapons/*" -o -path "*/multiplayer/*" -o -path "*/tips/*" -o -path "*/achievements/*" \) -name "*.html" | wc -l)
find out \( -path "*/guides/*" -o -path "*/walkthrough/*" -o -path "*/fish/*" -o -path "*/weapons/*" -o -path "*/multiplayer/*" -o -path "*/tips/*" -o -path "*/achievements/*" \) -name "*.html" | sort
if [ "$COUNT" -eq 0 ]; then
